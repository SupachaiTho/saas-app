class ArtifactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @artifact.save
        format.html { redirect_to tenant_project_path(tenant_id: Tenant.current_tenant_id,
  ...
  def destroy
    @artifact.destroy
    respond_to do |format|
      format.html { redirect_to tenant_project_path(tenant_id: Tenant.current_tenant_id, id:@artifact.project_id), notice: 'Artifact was successfully destroyed.' }
